  ...
  return (
    <div className="container-carrousel">
        <ul className='horizontal-list'>
            ...
            <Cardv1 nombre='Rotaract' texto="Los clubes Rotaract ofrecen a personas de 18 años de edad en adelante la oportunidad de intercambiar ideas con los líderes de la comunidad, adquirir habilidades profesionales y de liderazgo y, sobre todo, de servir y divertirse a la vez. Los socios de Rotary y Rotaract trabajan hombro a hombro en todo el mundo para tomar acción mediante el servicio. Ya sea en grandes urbes o zonas rurales, Rotaract marca el cambio en comunidades como la tuya."/>
